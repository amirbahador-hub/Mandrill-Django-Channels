...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "workgenius.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "workgenius.authentication.services.auth_jwt_response_payload_handler",
